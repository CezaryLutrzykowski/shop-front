      ...
      <div [formGroup]="parentForm" fxLayout="column">
          <mat-form-field appearance="fill">
              ...
              <div *ngIf="name?.invalid && (name?.dirty || name?.touched)" class="errorMessages">
                  ...
                  <div *ngIf="name?.errors?.['minlength']">Nazwa musi mieć przynajmniej 4 znaki</div>
              </div>
          </mat-form-field>
          ...
          <mat-form-field appearance="fill">
              ...
              <div *ngIf="slug?.invalid && (slug?.dirty || slug?.touched)" class="errorMessages">
                  <div *ngIf="slug?.errors?.['required']">Nazwa jest wymagana</div>
                  <div *ngIf="slug?.errors?.['minlength']">Nazwa musi mieć przynajmniej 4 znaki</div>
              </div>
          </mat-form-field>
          ...
          <mat-form-field appearance="fill">
              ...
              <div *ngIf="description?.invalid && (description?.dirty || description?.touched)" class="errorMessages">
                  <div *ngIf="description?.errors?.['required']">Opis jest wymagana</div>
                  <div *ngIf="description?.errors?.['minlength']">Opis musi mieć przynajmniej 4 znaki</div>
              </div>
          </mat-form-field>
          ...
          <mat-form-field appearance="fill">
              ...
              <div *ngIf="category?.invalid && (category?.dirty || category?.touched)" class="errorMessages">
                  <div *ngIf="category?.errors?.['required']">Kategoria jest wymagana</div>
                  <div *ngIf="category?.errors?.['minlength']">Kategoria musi mieć przynajmniej 4 znaki</div>
              </div>
          </mat-form-field>
          ...
          <mat-form-field appearance="fill">
              ...
              <div *ngIf="price?.invalid && (price?.dirty || price?.touched)" class="errorMessages">
                  ...
                  <div *ngIf="price?.errors?.['min']">Cena musi być większa od zera</div>
              </div>
          </mat-form-field>
